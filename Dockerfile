...
RUN cd .. && cd /home/user/
RUN mkdir nerfstudio && cd nerfstudio

# # Install nerfstudio dependencies.
RUN git clone https://github.com/nerfstudio-project/nerfstudio.git
RUN cd nerfstudio && python3.10 -m pip install -e . && cd ..

# # fix: AttributeError: module 'PIL.Image' has no attribute 'ANTIALIAS' at STEP: 
