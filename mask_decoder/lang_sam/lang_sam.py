...
from lang_sam.sam_imitate import NeuralNetwork
...
class LangSAM():
    ...
    def predict_sam(self, image_featues, image_pil, boxes):
    ...
    def predict(self, image_featues, image_pil, text_prompt, box_threshold=0.3, text_threshold=0.25):
        boxes, logits, phrases = self.predict_dino(image_pil, text_prompt, box_threshold, text_threshold)
        masks = torch.tensor([])
        if len(boxes) > 0:
            masks = self.predict_sam(image_featues, image_pil, boxes)
